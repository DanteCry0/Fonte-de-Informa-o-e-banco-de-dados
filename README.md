...
Repositório criado para a disciplina ministrada no 1°Semestre de CST GPI 
## 1) Projeto de Apresentação 
Projeto feito em forma de slide para apresentação dos integrantes do grupo formados durante aula de Banco de dados, com foco no uso de ferramentas de design para a produção da apresentação, usando a ferramenta Canva e conhecimentos previos de design
<b>
